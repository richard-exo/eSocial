...
namespace eSocial.Model.Eventos.XML
{
   public class s1005 : bEvento_XML
   {
      ...
      public override XElement genSignedXML(X509Certificate2 cert)
      {
         ...
         opTag("cnpjResp", infoEstab.inclusao.dadosEstab.cnpjResp),

         // aliqGilrat
         opElement("aliqGilrat", infoEstab.inclusao.dadosEstab.aliqGilrat.fap,
         opTag("aliqRat", infoEstab.inclusao.dadosEstab.aliqGilrat.aliqRat),
         ...
         // infoTrab->infoApr
         opElement("infoTrab", infoEstab.inclusao.dadosEstab.infoTrab.infoPCD.nrProcJud,
         opElement("infoTrab", infoEstab.inclusao.dadosEstab.infoTrab.infoPCD.nrProcJud,
         ...
         opTag("cnpjResp", infoEstab.alteracao.dadosEstab.cnpjResp),
         ...
         // infoCaepf 0.1
         opElement("infoCaepf", infoEstab.alteracao.dadosEstab.infoCaepf.tpCaepf,
         new XElement(ns + "tpCaepf", infoEstab.alteracao.dadosEstab.infoCaepf.tpCaepf)),
         ...
         // infoTrab->infoApr
         new XElement(ns + "infoApr", infoEstab.alteracao.dadosEstab.infoTrab.infoApr.nrProcJud,
      ...
      public struct sInfoEstab
      {
         ...
         public struct sDadosEstab
         {
            ...
            public string cnaePrep, cnpjResp;
